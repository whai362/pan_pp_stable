...
class JointDatasetLoader(data.Dataset):
    def __init__(self, split='train',
        ...
        self.gts['ic15'] = []
        img_names = [img_name for img_name in
                     mmcv.utils.scandir(ic15_train_data_dir, '.jpg')]
        img_names.extend([img_name for img_name in
                          mmcv.utils.scandir(ic15_train_data_dir, '.png')])
        for idx, img_name in enumerate(img_names):
        ...
        self.gts['tt'] = []
        img_names = [img_name for img_name in
                     mmcv.utils.scandir(tt_train_data_dir, '.jpg')]
        img_names.extend(
            [img_name for img_name in
             mmcv.utils.scandir(tt_train_data_dir, '.png')])
