...
EPS = 1e-6
ctw_root_dir = './data/CTW1500v2/'
ctw_train_data_dir = ctw_root_dir + 'train/text_image/'
ctw_train_gt_dir = ctw_root_dir + 'ctw1500_e2e_train/'
ctw_test_data_dir = ctw_root_dir + 'test/text_image/'
ctw_test_gt_dir = ctw_root_dir + 'ctw1500_e2e_test/'
...
class CTWv2Loader(data.Dataset):
    def __init__(self,
                 split='train',
                 is_transform=False,
                 img_size=None,
